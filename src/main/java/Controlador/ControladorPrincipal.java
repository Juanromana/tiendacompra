...
public class ControladorPrincipal implements ActionListener, ChangeListener, DocumentListener {
    ...
    Ver_detallefac verdeta = new Ver_detallefac();
    ...
    public ControladorPrincipal() {
        ...
        verdeta.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        tableproducto.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);

        prin.getTxtbucarventa().getDocument().addDocumentListener(this);
        ...
        tableproducto.getTxtbuscarpro().getDocument().addDocumentListener(this);
    }
    ...
    public void gestionarFactura_Compra() {
        ...
        verdeta.addWindowListener(new WindowAdapter() {
            ;
        public void windowClosed(WindowEvent e) {
                verdeta.setVisible(false);
                iniciarPrincipal(4);
            }
        });
        ...
        prin.getJtFactura().addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (columna == 9) {
                    ...
                    verdeta.setLocationRelativeTo(null);
                    verdeta.setTitle("Mostrar Detalle Factura | Ventana");
                }
            }
        });
    }
    ...
    public void gestionarVenta() {
        ...
        prin.getTxtbucarventa().addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                prin.getTxtbucarventa().setText("");
                prin.getTxtbucarventa().setForeground(Color.black);
            }
        });
    ...
    public void insertUpdate(DocumentEvent e) {
        ...
        modventa.mostrarVentaTabla(prin.getJtVenta(), prin.getTxtbucarventa().getText(), "Venta");
        modproduc.mostrarTablaProducto(tableproducto.getJtproducto(), tableproducto.getTxtbuscarpro().getText(), "");
