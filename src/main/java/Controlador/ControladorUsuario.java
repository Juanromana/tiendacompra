...
public class ControladorUsuario implements ActionListener {
    ...
    public void iniciarUsuario() {
        ...
        usu.getJcbsexo().addItem("Seleccionar:");
        Map<String, Integer> dato = modusu.llenarCombo("sexo");
        for (String sexo : dato.keySet()) {
            usu.getJcbsexo().addItem(sexo);
        }
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == (usu.getBtnGuardarUsuario())) {
            if (usu.getCbxtipodocu().getSelectedItem().equals("Seleccionar:") 
                    || usu.getTxtDocumento().getText().isEmpty() 
                    || usu.getTxtNombre().getText().isEmpty() 
                    || usu.getTxtTelefono().getText().isEmpty() 
                    || usu.getTxtCorreo().getText().isEmpty() 
                    || usu.getJDFechadeNaci().getDate() == null 
                    || usu.getTxtDireccion().getText().isEmpty() 
                    || usu.getJcbsexo().getSelectedItem().equals("Seleccionar:") 
                    || usu.getJcbCargo().getSelectedItem().equals("Seleccionar:") 
                    || usu.getTxtLogin().getText().isEmpty() 
                    || usu.getJpContra().getText().isEmpty()) {
                JOptionPane.showMessageDialog(null, "Hace Falta Informacion");
            } else {
                JOptionPane.showMessageDialog(null, "registro almacenado");
                String valorSexo = usu.getJcbsexo().getSelectedItem().toString();
                ...
                java.util.Date fec = usu.getJDFechadeNaci().getDate();
                long fe = fec.getTime();
                java.sql.Date fecha = new Date(fe);

                char[] contra = usu.getJpContra().getPassword();
                ...
                modusu.setSex(sexo);
                modusu.setRol(cargo);
                modusu.setTipodedoc(usu.getCbxtipodocu().getSelectedItem().toString());
    ...
    public void actualizarUsuario(int Doc) {
        ...
        usu.getJpContra().setText(modusu.getCl());
        usu.getTxtNombre().setText(modusu.getNom());
        usu.getJDFechadeNaci().setDate(modusu.getFec());
        usu.getTxtLogin().setText(modusu.getLo());
        usu.getCbxtipodocu().setSelectedItem(modusu.getTipodedoc());
        ...
        usu.getJcbsexo().setSelectedItem(valorSexo);
